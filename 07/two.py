...
candidates = [s for s in sizes.values() if 70000000 - sizes["/"] + s >= 30000000]
#print(sizes, candidates)
print(min(candidates))
assert min(candidates) == 8998590
# Fails: 1 (due to not computing correctly the minimum candidate size)
# Answer time: 07:00
# Total day time: 34:55 (AoC page reports 34:57)

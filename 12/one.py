...
steps = nx.shortest_path_length(G, src, dst)

print(f"Fewest steps required to move to the location with the best signal: {steps}")
assert steps == 440
# Fails: 2
# Answer time: 01:48:50 (AoC time)
# This was my first time using networkx and I needed some help implementing what I wanted to do (ty Seralpa).
# Also, I had a bug caused by not reading carefully enough the description (S and E heights). I realized that very late.

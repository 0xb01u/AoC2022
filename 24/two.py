...
for _ in range(3):
	...
	og, dst = dst, og
	print(f"Finished trip #{_ + 1}")

print(f"Fewest minutes required to reach the goal, go back to the start, then reach the goal again: {steps}")
# (I didn't time myself because my smartphone broke on 20 Dec. and that's what I was using as timer :C)
# Answer time: 03:05 (AoC time)
